      ...
      <div className="flex w-full mt-4">
        ...
        <div className="w-3/5 bg-white py-8 px-10 border-r border-gray-300">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            If you have any inquiries, feedback, or need support, we are here to
            help. Explore the services and resources available to you.
          </p>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 leading-snug mb-2">
              Learn how our service can help you resolve issues and provide
              context to streamline navigation.
            </p>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 leading-snug mb-2">
              Access detailed guides and features about our services or
              assistance programs.
            </p>
            <div className="border-t-2 border-black mb-4"></div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 leading-snug mb-2">
              Tips and tricks to maximize your experience and connect with the
              support system effectively.
            </p>
            <div className="border-t-2 border-black mb-4"></div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 leading-snug mb-2">
              Additional help sections, interactive guides, and external contact
        ...
        <div className="w-2/5 bg-gray-100 py-8 px-6 flex flex-col justify-center items-center">
          ...
          <p className="text-gray-600 text-center leading-relaxed mb-6 text-sm">
            We aim to provide reliable services tailored to all user needs.
            Explore our features for enhanced guidance and support.
          </p>
